...
void main(List<String> args) {
  ...
  // -> 순서가 없으므로 호출해서 사용코자 할 때는 
  //List형으로 변환 후 사용한다 -> Set형 변수.toList()

  
  // Set<int> evens = {2,4,6,8,10,4,'짝수'};
  ...
  // 4-3. Map 형 - 데이터의 라벨링된 데이터 집합
  //(객체와 유사)
  Map<String, String> actor = {'이름':"강동원",'나이':"43"};
  print(actor);
  ...
  // 2. 메서드 체인 방식 : 변수.to형()
  // -> 변수.toString() -> 문자형 변환
  // -> 변수.toList() -> 컬랙션 List형 변환

  // 주의: 형변환이 안될 것 같으면 변환하지 마라!
